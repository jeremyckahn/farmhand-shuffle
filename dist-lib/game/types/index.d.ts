...
export interface ITool extends ICard {
     ...
     */
    readonly applyDailyEffect?: (context: MatchMachineContext, idxOfCardInField: number) => MatchMachineContext;
}
/**
...
export type CardInstance = CropInstance | WaterInstance | EventInstance | ToolInstance;
export declare const isWaterCardInstance: (cardInstance: CardInstance) => cardInstance is WaterInstance;
export declare const isEventCardInstance: (cardInstance: CardInstance) => cardInstance is EventInstance;
export declare const isToolCardInstance: (cardInstance: CardInstance) => cardInstance is ToolInstance;
...
export declare enum MatchStateGuard {
...
export declare enum ShellNotificationType {
...
export interface MatchEventPayload {
    ...
    [MatchEvent.RESUME]: {
        ...
        matchState: MatchState.WAITING_FOR_PLAYER_SETUP_ACTION | MatchState.WAITING_FOR_PLAYER_TURN_ACTION;
        match: IMatch;
        botState: BotState;
        userPlayerId: string;
    };
