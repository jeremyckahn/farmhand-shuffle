...
import { CardInstance, EventInstance, IPlayedCrop, ToolInstance, WaterInstance } from '../../../game/types';
...
export type CardProps = CropCardProps | EventCardProps | ToolCardProps | WaterCardProps;
