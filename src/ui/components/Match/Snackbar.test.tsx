...
describe('Snackbar', () => {
  ...
  it('renders message when provided', () => {
    renderWithTheme(
      <Snackbar message="Test Message" severity="info" onClose={vi.fn()} />
    )
  ...
  it('closes after duration', () => {
    ...
    renderWithTheme(
      <Snackbar message="Test Message" severity="info" onClose={onClose} />
    )
  ...
  it('resets timer when message updates', () => {
    ...
    const { rerender } = renderWithTheme(
      <Snackbar message="Message 1" severity="info" onClose={onClose} />
    )
    ...
    rerender(
      <ThemeProvider theme={theme}>
        <Snackbar message="Message 2" severity="info" onClose={onClose} />
      </ThemeProvider>
    )
  ...
  it('displays previous message while closing/transitioning if current message is empty', () => {
    ...
    const onClose = vi.fn()
    const { rerender } = renderWithTheme(
      <Snackbar message="Initial Message" severity="info" onClose={onClose} />
    )
